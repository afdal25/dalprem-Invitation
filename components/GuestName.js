...
// Kita pisahkan logikanya ke komponen internal agar bisa dibungkus Suspense
function GuestContent() {
  ...
  return (
    ...
    >
      <p className="font-body text-[10px] md:text-xs text-[#F3E5AB] tracking-[0.2em] uppercase mb-3 opacity-80">
        Kepada Yth. Bapak/Ibu/Saudara/i:
      </p>
      
      {/* Kotak Nama dengan Desain Kaca & Border Emas */}
      <div className="bg-[#1B4D3E]/40 backdrop-blur-md border border-[#D4AF37]/50 px-8 py-3 rounded-full inline-block shadow-lg shadow-[#1B4D3E]/20">
